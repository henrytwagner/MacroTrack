...
export default function LogScreen() {
  ...
  return (
    ...
    >
      ...
      {!isToday && (
        <View
          style={[styles.dateIndicator, { backgroundColor: colors.warning + '20' }]}
        >
          <Ionicons name="calendar-outline" size={14} color={colors.warning} />
          <ThemedText
            style={[Typography.footnote, { color: colors.warning, fontWeight: '600' }]}
          >
      ...
      <View style={styles.actionRow}>
        ...
        >
          <ThemedText
            style={[Typography.subhead, { color: colors.tint, fontWeight: '600' }]}
          >
            My Foods
          </ThemedText>
        </Pressable>
                ...
                {hasSearchResults ? (
                  ...
                  <View style={styles.noResults}>
                    ...
                    >
                      ...
                      <ThemedText
                        style={[Typography.subhead, { color: colors.tint }]}
                      >
