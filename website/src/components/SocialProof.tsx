const stats = [
  {
    ...
    color: "text-cal-red",
    borderColor: "border-t-cal-red/60",
  },
  {
    value: "500K+",
    label: "USDA foods",
    ...
    borderColor: "border-t-carb-orange/60",
  },
  {
    value: "<3s",
...
export default function SocialProof() {
  return (
    <section className="relative py-28 sm:py-36">
      {/* Bold warm background */}
      <div className="absolute inset-0 bg-gradient-to-b from-cal-red/[0.04] via-transparent to-carb-orange/[0.04]" />
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
          {stats.map((stat) => (
            <div
              key={stat.label}
              className={`text-center p-8 bg-card-bg border border-card-border border-t-2 ${stat.borderColor} rounded-2xl`}
            >
        ...
        <div className="mt-16 text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-8 text-muted/60">
            <div className="flex items-center gap-2">
              <svg className="w-5 h-5 text-cal-red/60" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285z" />
              </svg>
              <span className="text-sm font-medium">USDA FoodData Central</span>
            </div>
            <div className="flex items-center gap-2">
              <svg className="w-5 h-5 text-carb-orange/60" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
